...
import org.treblereel.gwt.jackson.api.stream.impl.JsNativeXMLWriter;

/**
 * @author Dmitrii Tikhomirov
 * Created by treblereel 4/18/20
 */
public class JsXMLSerializationContext implements XMLSerializationContext {
    ...
    private JsXMLSerializationContext(boolean serializeNulls, boolean writeDatesAsTimestamps,
     ...
     */
    public static JsXMLSerializationContext.Builder builder() {
        return new JsXMLSerializationContext.DefaultBuilder();
    }
     ...
     * @see DefaultXMLSerializationContext.Builder#serializeNulls(boolean)
     */
    @Override
     ...
     * @see DefaultXMLSerializationContext.Builder#writeDatesAsTimestamps(boolean)
     */
    @Override
     ...
     * @see DefaultXMLSerializationContext.Builder#writeDateKeysAsTimestamps(boolean)
     */
    @Override
     ...
     * @see DefaultXMLSerializationContext.Builder#writeNullMapValues(boolean)
     */
    @Override
     ...
     * @see DefaultXMLSerializationContext.Builder#writeEmptyXMLArrays(boolean)
     */
    @Override
     ...
     * @see DefaultXMLSerializationContext.Builder#orderMapEntriesByKeys(boolean)
     */
    @Override
    ...
    public XMLWriter newXMLWriter() throws XMLStreamException {
        XMLWriter writer = new JsNativeXMLWriter();
        return writer;
    }
    ...
    public static class Builder {
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder useEqualityForObjectId(boolean useEqualityForObjectId) {
            this.useEqualityForObjectId = useEqualityForObjectId;
            return this;
        }

        public JsXMLSerializationContext.Builder mapKeyAndValueCanonical(boolean mapKeyAndValueCanonical) {
            this.mapKeyAndValueCanonical = mapKeyAndValueCanonical;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder serializeNulls(boolean serializeNulls) {
            this.serializeNulls = serializeNulls;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder writeDatesAsTimestamps(boolean writeDatesAsTimestamps) {
            this.writeDatesAsTimestamps = writeDatesAsTimestamps;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder writeDateKeysAsTimestamps(boolean writeDateKeysAsTimestamps) {
            this.writeDateKeysAsTimestamps = writeDateKeysAsTimestamps;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder writeNullMapValues(boolean writeNullMapValues) {
            this.writeNullMapValues = writeNullMapValues;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder writeEmptyXMLArrays(boolean writeEmptyXMLArrays) {
            this.writeEmptyXMLArrays = writeEmptyXMLArrays;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder orderMapEntriesByKeys(boolean orderMapEntriesByKeys) {
            this.orderMapEntriesByKeys = orderMapEntriesByKeys;
            return this;
        }
         ...
         * @return the builder
         */
        public JsXMLSerializationContext.Builder wrapExceptions(boolean wrapExceptions) {
            this.wrapExceptions = wrapExceptions;
            return this;
        }

        public JsXMLSerializationContext.Builder wrapCollections(boolean wrapCollections) {
            this.wrapCollections = wrapCollections;
            return this;
        }

        public final XMLSerializationContext build() {
            return new JsXMLSerializationContext(serializeNulls, writeDatesAsTimestamps,
    ...
    public static class DefaultBuilder extends JsXMLSerializationContext.Builder {
