...
{    
    ...
    public enum As {
         ...
         * custom serializer).
         *<p>
         * Note that this behavior is quite similar to that of using {@link XMLTypeId}
         * annotation;
         * except that here <code>TypeSerializer</code> is basically suppressed;
         * whereas with {@link XMLTypeId}, output of regular property is suppressed.
     ...
     *    for such usage.
     *  </li>
     * <li>Placeholder value of {@link XMLTypeInfo} (that is, this annotation type
     ...
     * </ul>
     */
    public Class<?> defaultImpl() default XMLTypeInfo.class;
     ...
     * specified.
     * 
     * @deprecated Since 2.5, use any Annotation type (such as {@link XMLTypeInfo},
