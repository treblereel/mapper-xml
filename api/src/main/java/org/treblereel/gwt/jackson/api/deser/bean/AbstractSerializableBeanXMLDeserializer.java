...
/**
 * <p>Abstract AbstractSerializableBeanXMLDeserializer class.</p>
 *
 * @author Nicolas Morel
 * @version $Id: $
 */
@SuppressWarnings("UnusedDeclaration")
public abstract class AbstractSerializableBeanXMLDeserializer extends AbstractBeanXMLDeserializer<Serializable> {

    private ArrayListXMLDeserializer<Serializable> listXMLDeserializer;

    private LinkedHashMapXMLDeserializer<String, Serializable> mapXMLDeserializer;
    ...
    /** {@inheritDoc} */
    @Override
    public Serializable deserializeWrapped(XMLReader reader, XMLDeserializationContext ctx, XMLDeserializerParameters params,
                                           IdentityDeserializationInfo identityInfo, TypeDeserializationInfo typeInfo,
                                           String typeInformation) {
        switch (reader.peek()) {
            case NUMBER:
                return BaseNumberXMLDeserializer.NumberXMLDeserializer
