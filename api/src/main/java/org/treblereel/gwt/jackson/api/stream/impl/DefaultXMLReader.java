 ...
 *       } else if (name.equals("geo") && reader.peek() != XMLToken.NULL) {
...
public class DefaultXMLReader implements XMLReader {
     ...
     *
     * @param in a {@link StringReader} object.
     */
    public DefaultXMLReader(StringReader in) {
        if (in == null) {
    ...
    public XMLToken peek() {
        ...
        switch (p) {
            case PEEKED_BEGIN_OBJECT:
                return XMLToken.BEGIN_OBJECT;
            case PEEKED_END_OBJECT:
                return XMLToken.END_OBJECT;
            case PEEKED_BEGIN_ARRAY:
                return XMLToken.BEGIN_ARRAY;
            case PEEKED_END_ARRAY:
                return XMLToken.END_ARRAY;
            ...
            case PEEKED_TRUE:
            case PEEKED_FALSE:
                return XMLToken.BOOLEAN;
            case PEEKED_NULL:
                return XMLToken.NULL;
            case PEEKED_SINGLE_QUOTED:
            case PEEKED_DOUBLE_QUOTED:
            case PEEKED_UNQUOTED:
            case PEEKED_BUFFERED:
                return XMLToken.STRING;
            case PEEKED_LONG:
            case PEEKED_NUMBER:
                return XMLToken.NUMBER;
            case PEEKED_EOF:
     ...
     */
        ...
        if (throwOnEof) {
            ...
            throw new XMLDeserializationException(mess);
        } else {
            return -1;
        }
    }
