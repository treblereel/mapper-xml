 ...
 * <p>
 * <h3>Encoding JSON</h3>
 * To encode your data as JSON, create a new {@code XMLWriter}. Each JSON
 ...
 *   {
 *     "id": 912345678902,
 *     "text": "@json_newb just use XMLWriter!",
 ...
 *     XMLWriter writer = new XMLWriter(new OutputStreamWriter(out, "UTF-8"));
 *     writer.setIndentSpaces(4);
 *     writeMessagesArray(writer, messages);
 *     writer.close();
 *   }
 * <p>
 *   public void writeMessagesArray(XMLWriter writer, List<Message> messages) {
 *     writer.beginArray();
 ...
 *   }
 * <p>
 *   public void writeMessage(XMLWriter writer, Message message) {
 *     writer.beginObject();
 ...
 *   }
 * <p>
 *   public void writeUser(XMLWriter writer, User user) {
 *     writer.beginObject();
 ...
 *   }
 * <p>
 *   public void writeDoublesArray(XMLWriter writer, List<Double> doubles) {
 *     writer.beginArray();
 ...
 *   }}</pre>
 * <p>
 * <p>Each {@code XMLWriter} may be used to write a single JSON stream.
...
public class DefaultXMLWriter implements XMLWriter {
     ...
     */
    public DefaultXMLWriter(StringBuilder out) {
        if (out == null) {
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter beginArray() {
        writeDeferredName();
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter endArray() {
        return close(JsonScope.EMPTY_ARRAY, JsonScope.NONEMPTY_ARRAY, "]");
    }

    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter beginObject() {
        writeDeferredName();
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter endObject() {
     ...
     * bracket.
     */
    private DefaultXMLWriter open(int empty, String openBracket) {
        beforeValue(true);
        push(empty);
     ...
     * given bracket.
     */
    private DefaultXMLWriter close(int empty, int nonempty, String closeBracket) {
        int context = peek();
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter value(String value) {
        if (value == null) {
            return nullValue();
        }
        writeDeferredName();
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter unescapeValue(String value) {
        if (value == null) {
            return nullValue();
        }
        writeDeferredName();
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter nullValue() {
        if (deferredUnescapeName != null || deferredName != null) {
            if (serializeNulls) {
                writeDeferredName();
            } else {
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter cancelName() {
        if (deferredUnescapeName != null) {
            deferredUnescapeName = null;
        } else if (deferredName != null) {
            deferredName = null;
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter value(boolean value) {
        writeDeferredName();
        beforeValue(false);
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter value(double value) {
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter value(long value) {
        writeDeferredName();
        beforeValue(false);
    ...
    /** {@inheritDoc} */
    @Override
    public DefaultXMLWriter value(Number value) {
        if (value == null) {
            return nullValue();
        }
