...
public enum XmlAccessType {
  /**
   * Every getter/setter pair in a JAXB-bound class will be automatically bound to XML, unless
   * annotated by {@link XmlTransient}.
   *
   * <p>Fields are bound to XML only when they are explicitly annotated by some of the JAXB
   * annotations.
   */
  PROPERTY,
  /**
   ...
   * access are bound to XML only when they are explicitly annotated by the appropriate JAXB
   * annotations.
   */
  PUBLIC_MEMBER,
  /**
   * None of the fields or properties is bound to XML unless they are specifically annotated with
   * some of the JAXB annotations.
   */
  NONE
}
