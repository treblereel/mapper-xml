 ...
 * <p><b>Usage</b>
 *
 * <p></tt>@XmlElement</tt> annotation can be used with the following program elements:
 *
 * <ul>
 ...
 *       <tt>@XmlElement.type()</tt> must be DEFAULT.class since the collection item type is already
 *       known.
 * </ul>
 *
...
public @interface XmlElement {
   ...
   *
   * <p>The '\u0000' value specified as a default of this annotation element is used as a poor-man's
