 ...
 */
@GwtIncompatible
public final class ServerJacksonXMLDeserializerParameters implements XMLDeserializerParameters {

    /**
     * Constant <code>DEFAULT</code>
     */
    public static final XMLDeserializerParameters DEFAULT = new ServerJacksonXMLDeserializerParameters();
