...
public class MapperSuite {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.XmlRootElementTest.class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.accessortype.CustomerTest.class);
    ...
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.namespace.test2.NamespaceTest.class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.namespace.test3.NamespaceTest.class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.namespace.test4.NamespaceTest.class);
    suite.addTestSuite(SeeAlsoTest.class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.type.CustomerTest.class);
    suite.addTestSuite(XsiTypeTest.class);
    suite.addTestSuite(WrapperTest.class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.xmlaccesstype.field.CustomerTest
            .class);
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.xmladapter.MyTestBeanTest.class);
    ...
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.annotations.xmladapter.pkg.MyTestBeanTest.class);
    ...
    suite.addTestSuite(
        org.treblereel.gwt.xml.mapper.client.tests.beans.company.XmlRootElementTest.class);
    ...
    suite.addTestSuite(org.treblereel.gwt.xml.mapper.client.tests.boxed.BooleanTest.class);
    ...
    suite.addTestSuite(org.treblereel.gwt.xml.mapper.client.tests.primitive.BooleanTest.class);
