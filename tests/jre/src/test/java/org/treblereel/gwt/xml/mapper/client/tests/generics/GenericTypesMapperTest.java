...
public class GenericTypesMapperTest {
  ...
  public void testGenericObject() throws XMLStreamException {
    ...
    genericWithString.genericArr[1] = Arrays.asList("my", "name", "is", "xml-mapper-apt");
