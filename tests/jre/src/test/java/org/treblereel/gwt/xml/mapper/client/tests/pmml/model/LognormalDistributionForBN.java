...
@XmlType(
    name = "",
    propOrder = {"extension", "mean", "variance"})
@XmlRootElement(name = "LognormalDistributionForBN")
@JsType
public class LognormalDistributionForBN implements IContinuousDistribution {
   ...
   *
   * @return possible object is {@link Variance }
   */
   ...
   *
   * @param value allowed object is {@link Variance }
   */
